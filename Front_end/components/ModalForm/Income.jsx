      ...
      <div>
        <div className="flex flex-col">
          <div className="bg-slate-50 2xl:mt-5 p-1 mt-3 w-full max-w-xs lg:max-w-[280px] rounded-xl 2xl:max-w-sm">
            ...
            <button className="btn btn-sm bg-success hover:bg-green-500 w-1/2">
              Income
            </button>
          </div>
          <div className="">
          ...
          <div class="relative inline-block text-left  ">
            ...
            >
              <div class="py-1" role="none">
                <button
                  className="btn mt-5 text-gray-700 block px-4 py-2 text-sm"
                  role="menuitem"
                  tabindex="-1"
                  id="menu-item-0"
                  onClick={() =>
        ...
        <div className="mt-3">
          <button className="btn bg-success w-full lg:max-w-[283px] 2xl:max-w-xs ">
            Add
          </button>
        </div>
      </div>
